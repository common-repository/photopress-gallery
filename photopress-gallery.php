...
function photopress_gallery_shortcode( $output, $attr = array() ) {
        ...
        // diable responsive image srcsets on thumbnails which should always remain the same size.
        // without some browsers will download more than one imge for each thumbnail
        ...
        // re-enable the responsive image srcset for non gallery images.
